...
class FoodTableViewController: UITableViewController {
    ...
    var foodNames = ["Fish & Chips", "Burgers","Donouts"]
    
    var foodImages = ["1.jpg", "2.jpg","1.jpg"]
    
    var foodType = ["Dessert", "Drinks","snack"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.foodImg.image = UIImage(named: foodImages[indexPath.row])
        cell.typeLabel.text = foodType[indexPath.row]
